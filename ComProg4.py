print("Task 4") 
# Student Identity 
LAST_NAME = "Belnas"      # Replace with surname 
STUDENT_ID = "TUPM-24-0291" # Replace with ID 
...
raw_data = [base_val, base_val + 5, base_val, sys_config["vector_dim"], base_val 
+ 5] 
